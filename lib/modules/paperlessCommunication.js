	...
	**************************************************************************************************** */
	...
	async sendGlobalSearchQuery(query){
		...
		try{
			...
			// Assign Count
			this.globalSearch.datastructure.global.results.total = erg.data.total;

			// Assign the whole structure
			for(const element in erg.data){
				this.globalSearch.datastructure.global.results[element] = {};
				if(typeof erg.data[element] !== "object"){
					this.globalSearch.datastructure.global.results[element] = erg.data[element];
				}
				else{
					for(const elementdata of erg.data[element]){
						this.globalSearch.datastructure.global.results[element][this.expandIndex(elementdata.id)] = elementdata;
					}
				}
			}

			// Assign document specific data
			for(const document in this.globalSearch.datastructure.global.results.documents){
				//Assign Links to documentfolder
				const id = this.globalSearch.datastructure.global.results.documents[document].id;
				this.globalSearch.datastructure.global.results.documents[document].links = {
					download: {
				...
				this.globalSearch.datastructure.global.results.documents[document].tags = {
					additionalObjectinformations: {
						type: "state",
						common: {
							name: "tags",
						...
						objectValue: this.globalSearch.datastructure.global.results.documents[document].tags
					}
				};
			}
	...
	**************************************************************************************************** */
	...
	async sendDocumentsSearchQuery(query){
		...
		try{
			...
			// Assign the count
			this.documentsSearch.datastructure.documents.results.count = erg.data.count;

			//Assign results for documents
			for(const result of erg.data.results){
				this.documentsSearch.datastructure.documents.results.documents[this.expandIndex(result.id)] = result;
			}
			while(erg.data.next){
			...
			for(const document in this.documentsSearch.datastructure.documents.results.documents){
				//Assign Links to resultfolder
				const id = this.documentsSearch.datastructure.documents.results.documents[document].id;
				this.documentsSearch.datastructure.documents.results.documents[document].links = {
					download: {
						additionalObjectinformations: {
							type: "state",
							common: {
				...
				// Assign the type of tags
				this.documentsSearch.datastructure.documents.results.documents[document].tags = {
					additionalObjectinformations: {
						type: "state",
						common: {
							name: "tags",
						...
						objectValue: this.documentsSearch.datastructure.documents.results.documents[document].tags
					}
				};
			}
